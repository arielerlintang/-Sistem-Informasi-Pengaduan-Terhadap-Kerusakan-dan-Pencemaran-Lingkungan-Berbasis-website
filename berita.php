...
<?php 
	...
	$berita = array();
	$ambil = $koneksi->query("SELECT * FROM berita LEFT JOIN admin ON admin.id_admin = berita.id_admin WHERE id_kategori = '$id_kategori' ");
 ...
 ?>
				...
				<div class="col-md-4">
                    ...
                    <img src="assets/files/berita/<?php echo $value['foto_berita']; ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title fw-bold"><?php echo strtoupper($value["judul_berita"]); ?></h5>

                        <p class="card-text"><span class="bi bi-person-circle text-muted" style="text-transform: capitalize;">By : <?php echo $value['nama_admin']; ?></span><small class="text-muted"> | <i class="bi bi-calendar"></i><?php echo date("d/m/Y", strtotime($value["tanggal_berita"])); ?></small></p>
