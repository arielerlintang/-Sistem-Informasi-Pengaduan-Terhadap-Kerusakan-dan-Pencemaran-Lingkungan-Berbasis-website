...
<?php 
$id_berita = $_GET["id"];
$ambil_berita = $koneksi->query("SELECT * FROM berita LEFT JOIN admin ON admin.id_admin = berita.id_admin WHERE  id_berita = '$id_berita' ");
			...
			<div class="row">
				<div class="col-md-8 mb-4">
					<div class="card p-4 bg-white card shadow">
							...
							<img src="assets/files/berita/<?php echo $berita['foto_berita']; ?>" class="rounded">
							<strong class="text-muted" style="font-size: 12px;"><i class="bi bi-person-circle"> By: <?php echo $berita['nama_admin'] ?></i> <i class="bi bi-calendar"></i> <?php echo date("D, d/m/Y", strtotime($berita["tanggal_berita"])); ?></strong>
				...
				<div class="col-md-4">
					<div class="card p-3 bg-white shadow">
						...
						<?php foreach ($berita_semua as $key => $value): ?>
							...
							<div class="col-md-5">
								<div class="">
									<img src="assets/files/berita/<?php echo $value['foto_berita'] ?>" width="100">
								</div>
							</div>
