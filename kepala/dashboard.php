...
<div class="container-fluid px-4">
    ...
    <div class="row">
        <div class="col-md-10 offset-md-1 shadow rounded bg-white p-5 my-5">
            <p>Selamat datang <strong><?php echo $_SESSION['kepala']["nama_kepala"]; ?></strong></p>
            <strong><i class="bi bi-check tetx-success"></i> Kelola Data Aduan Yang Baru masuk Melalui Panel Ini</strong>
